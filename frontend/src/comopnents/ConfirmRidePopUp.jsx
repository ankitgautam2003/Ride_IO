        ...
        <div className="mt-6 w-full">
          ...
          >
            <input
              ...
              className="bg-[#eee] px-6 py-4 font-mono text-base rounded-lg w-full mt-2"
            />
            <Link
              to="/captain-riding"
              className="w-full mt-5 bg-green-600 text-white p-2 rounded-full font-semibold text-lg flex justify-center"
            >
              Confirm Ride
            </Link>
            ...
            <button
              ...
              className="w-full mt-2 bg-red-500 text-white p-2 rounded-full font-semibold text-lg"
            >
              Cancel Ride
            </button>
          </form>
